...
class Cast {
    ...
    get fullProfilePath {
      {
      if(profilePath != null ) {
        return  'https://image.tmdb.org/t/p/w500$profilePath'; //Es la forma como se llama un imagen en la api https://developers.themoviedb.org/3/getting-started/images
      }
